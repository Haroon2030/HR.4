...
هذا الملف يحتوي على كل شاشات إدارة مسير الرواتب:
  ...
  2. view_payroll_run    — عرض تفاصيل مسير (أسطر الموظفين)
  3. rebuild_payroll_run — إعادة بناء مسير DRAFT (يحدّث الأرقام)
  4. lock_payroll_run    — ترحيل المسير (ربط البنود وتأكيدها)
  5. unlock_payroll_run  — إلغاء الترحيل (سوبر يوزر فقط)
  6. export_payroll_run  — تصدير المسير إلى Excel
...
# ══════════════════════════════════════════════════════════════════════════════
# 2. عرض تفاصيل مسير — أسطر الموظفين مع كل البنود
# ══════════════════════════════════════════════════════════════════════════════
